...
public final class BlastResistanceBlockCondition implements ConditionType<BlockCtx, BlastResistanceBlockCondition.Cfg> {
    ...
    public boolean test(Cfg cfg, BlockCtx ctx) {
        return cfg.comparison.compare(ctx.state().getBlock().getExplosionResistance(), cfg.compareTo);
    }
}
