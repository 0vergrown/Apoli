...
public final class AmountItemCondition implements ConditionType<ItemCtx, AmountItemCondition.Cfg> {
    ...
    public boolean test(Cfg cfg, ItemCtx ctx) {
        return cfg.comparison.compare(ctx.stack().getCount(), cfg.compareTo);
    }
}
