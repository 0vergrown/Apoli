...
public final class HeightBlockCondition implements ConditionType<BlockCtx, HeightBlockCondition.Cfg> {
    ...
    public boolean test(Cfg cfg, BlockCtx ctx) {
        return cfg.comparison.compare(ctx.pos().getY(), cfg.compareTo);
    }
}
