...
public final class AirCondition implements ConditionType<EntityCtx, AirCondition.Cfg> {
    ...
    public boolean test(Cfg cfg, EntityCtx ctx) {
        return cfg.comparison.compare(ctx.entity().getAirSupply(), cfg.compareTo);
    }
}
