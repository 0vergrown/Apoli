...
public final class DurabilityItemCondition implements ConditionType<ItemCtx, DurabilityItemCondition.Cfg> {
    ...
    public boolean test(Cfg cfg, ItemCtx ctx) {
        ...
        int remaining = stack.isDamageableItem() ? (stack.getMaxDamage() - stack.getDamageValue()) : 0;
        return cfg.comparison.compare(remaining, cfg.compareTo);
    }
}
