...
public final class RopeClientManager {
    ...
    private static void driveLocalRope(VerletRopeState rope, Minecraft client, ClientLevel level) {
        ...
        sendC2S(RopeSwingC2S.CHANNEL, new RopeSwingC2S(rope.id, dir.lengthSqr() > 1 ? dir.normalize() : dir)::write);
    }

    private static void sendC2S(ResourceLocation channel, Consumer<FriendlyByteBuf> writer) {
