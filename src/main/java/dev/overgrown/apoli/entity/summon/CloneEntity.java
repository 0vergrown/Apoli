...
public class CloneEntity extends Monster implements OwnableEntity, CrossbowAttackMob, Temporary {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(WIDE_TEXTURE, "");
        this.entityData.define(SLIM_TEXTURE, "");
    }
    ...
    public void performRangedAttack(LivingEntity target, float pullProgress) {
        ...
        AbstractArrow arrow = ProjectileUtil.getMobArrow(this, arrowStack, pullProgress);
    ...
    @Override
    public void shootCrossbowProjectile(LivingEntity target, net.minecraft.world.item.ItemStack crossbow, net.minecraft.world.entity.projectile.Projectile projectile, float spray) {
        this.shootCrossbowProjectile(this, target, projectile, spray, 1.6f);
    }
