...
public final class ModifyTypeTagPower extends PowerType<ModifyTypeTagPower.Cfg> {
    ...
    private static final List<TagKey<EntityType<?>>> LEGACY_GROUPS = List.of(
        TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.withDefaultNamespace("undead")),
        TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.withDefaultNamespace("arthropod")),
        TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.withDefaultNamespace("illager")),
        TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.withDefaultNamespace("aquatic")));
