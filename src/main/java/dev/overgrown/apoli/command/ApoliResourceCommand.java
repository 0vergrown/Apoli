        ...
        for(var target : targets) {
            ...
            switch (operation) { //"%=", "*=", "+=", "-=", "/=", "<", "=", ">", "><"
                ...
                case "/=":
                    ...
                    break;
                case "<":
                    value = Math.min(value, sourceScore.getScore());
                    break;
                case "=":
                    value = sourceScore.getScore();
                    break;
                case ">":
                    value = Math.max(value, sourceScore.getScore());
                    break;
                case "><":
                    var newValue = sourceScore.getScore();
                    sourceScore.setScore(value);
                    value = newValue;
                    break;
            }
