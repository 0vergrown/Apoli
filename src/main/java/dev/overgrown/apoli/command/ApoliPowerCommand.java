...
public final class ApoliPowerCommand {
    /** Suggests every power id currently loaded by the reload listener (recursive, includes subfolders). */
    ...
    /** Suggests only powers currently held by at least one of the target entities. Falls back to all loaded powers. */
    ...
    /** Suggests sources currently attached to the target entities for the chosen power. */
    ...
    /** Suggests every source currently attached to the targets across all their powers. */
