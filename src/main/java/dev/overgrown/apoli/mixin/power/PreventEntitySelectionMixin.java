...
public class PreventEntitySelectionMixin {
    @ModifyExpressionValue(method = "method_18144(Lnet/minecraft/world/entity/Entity;)Z", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;isPickable()Z"))
